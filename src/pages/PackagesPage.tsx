import {  Calendar, TrendingUp, Users, Shield, Mountain,  ChevronRight, Star,  Thermometer,  Heart,  } from 'lucide-react';
          ...
          >
            {trekPackages.map((trek) => (
              <motion.div
                ...
                className="relative overflow-hidden rounded-2xl bg-white shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100"
              >
                ...
                <div className="p-6">
                  ...
                  <Link
                    to={`/trek/${trek.id}`}
                    className="block w-full py-2.5 px-4 bg-gradient-to-r from-cyan-600 to-blue-700 text-white font-semibold rounded-lg text-center hover:opacity-90 transition-all duration-300"
                  >
                    View Details
                  </Link>
                </div>
